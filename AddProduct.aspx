<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="Admin_AddProduct" %>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <asp:TextBox ID="txtCategory" runat="server" CssClass="form-control" Placeholder="Category" required onblur="validateinput(this)" Style="border-bottom: 1px solid #D2042D;"> </asp:TextBox>

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="txtEmail">Price</label>
                                                    <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control" Placeholder="Enter Price" Style="border-bottom: 1px solid #D2042D;" required> </asp:TextBox>

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="txtStock">Stock</label>
                                                    <asp:TextBox ID="txtStock" runat="server" MaxLength="10" CssClass="form-control" Placeholder="Stock" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" Style="border-bottom: 1px solid #D2042D;" required> </asp:TextBox>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="txtItemCode">ItemCode</label>
                                                    <asp:TextBox ID="txtItemCode" runat="server" CssClass="form-control" Placeholder="ItemCode" Style="border-bottom: 1px solid #D2042D;" required> </asp:TextBox>

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="chkStatus">Is InActive </label>

                                                    <div class="checkbox-wrapper-55">
                                                        <label class="rocker rocker-small">
                                                            <input type="checkbox" id="chkStatus" runat="server">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row mb-3 mr-lg-5 ml-lg-5">
                                                        <div class="col-md-3 col-md-offset-2 mb-3">
                                                            <asp:Button ID="btnLogin" runat="server" OnClick="btnAdd_Click1" CssClass="btn btn-danger" Text="Add" />
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true" SettingsBehavior-AllowGroup="true"
                                                                ...
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="150px" FieldName="ProductName" Caption="Customer ID" VisibleIndex="0">
                                                                   ...
                                                                   <%-- <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="50px" FieldName="Status" Caption="Status" VisibleIndex="1">
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="250px" FieldName="Category" Caption="Customer Name" VisibleIndex="1">
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains"></Settings>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="50px" FieldName="Price" Caption="Price" VisibleIndex="2">
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains"></Settings>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="90px" FieldName="StockInInventory" Caption="StockInInventory" VisibleIndex="3">
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains"></Settings>
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="50px" FieldName="ItemCode" Caption="ItemCode" VisibleIndex="4">
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains"></Settings>
                                                                    </dx:GridViewDataTextColumn>

                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="70px" FieldName="CreatedBy" Caption="CreatedBy<br/> By" VisibleIndex="5">
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                        <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains"></Settings>
                                                                    </dx:GridViewDataTextColumn>

                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Edit" ReadOnly="True" Visible="true" VisibleIndex="6" Width="40px">
                                                                        <DataItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton1" EnableViewState="false" runat="server"
                                                                                OnClientClick="lp.Show()"
                                                                                OnCommand="btnEdit_Command" CommandArgument='<%# Eval("ProductID") %>' CausesValidation="False" CommandName="Select"><img src="../Assest/Img/edit.jpg" alt="" height="15px" width="14px" /></asp:LinkButton>
                                                                        </DataItemTemplate>
                                                                    </dx:GridViewDataTextColumn>

                                                                    <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Delete" ReadOnly="True" VisibleIndex="7" Width="40px">
                                                                        <DataItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton2" runat="server" EnableViewState="false" CausesValidation="False" CommandName="Delete" Text="Delete" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("ProductID") %>'
                                                                                OnClientClick="if(!SamplePopupDelete(this.id))return false;">
                                                                                                <img src="../Assest/Img/delete.jpg" alt="" height="15px" width="14px"  /> </asp:LinkButton>
                                                                        </DataItemTemplate>
                                                                    </dx:GridViewDataTextColumn>
                                                            ...
                                                            <%-- <asp:GridView ID="gvList" OnDataBinding="gvList_DataBinding" runat="server" AutoGenerateColumns="false" CellPadding="4" Width="100%" AllowPaging="true" CellSpacing="1" HeaderStyle-BackColor="#D2042D" HeaderStyle-CssClass="headerrr" HeaderStyle-HorizontalAlign="Center" BorderColor="Black" BorderStyle="Solid" GridLines="Both">

                                                            <Columns>

                                                                <asp:BoundField DataField="ProductName" HeaderText="Product Name" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="Category" HeaderText="Category" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="Price" HeaderText="Price" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="StockInInventory" HeaderText="Stock In Inventory" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="ItemCode" HeaderText="ItemCode" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />

                                                                <asp:TemplateField HeaderText="Status" ItemStyle-CssClass="borderrr">
                                                                    <ItemTemplate>
                                                                        <input id="chkStatus" type="checkbox" <%# Convert.ToBoolean(Eval("IsInActive")) ? "checked='checked'" : "" %> />
                                                                        <label for="chkStatus"></label>
                                                                    </ItemTemplate>

                                                                </asp:TemplateField>

                                                                <asp:BoundField DataField="CreatedBy" HeaderText="Created By" ItemStyle-ForeColor="Black" ItemStyle-CssClass="borderrr" ItemStyle-HorizontalAlign="Center" />


                                                                <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="borderrr">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton1" OnCommand="btnEdit_Command" CommandArgument='<%# Eval("ProductID") %>' runat="server" CausesValidation="False" CommandName="Select">
                                                <Image src="../Content/Icons/Edit.png" Width="25" Height="25"></Image>
                                                                        </asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="borderrr">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnCommand="btnDelete_Command" CommandArgument='<%# Eval("ProductID") %>'>
                                                <Image src="../Content/Icons/Delete.png" Width="25" Height="25"></Image>
                                                                        </asp:LinkButton>
